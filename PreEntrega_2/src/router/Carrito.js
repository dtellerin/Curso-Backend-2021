const persistencia = 'FireBase' //variable de inicio que indica el metodo de persistencia. Las opciones son "Memoria", "Archivos", "MongoDB" o "FireBase". El default es Memoria.
import {PersistenciaCarritos} from '../../daos/index.js'
 
const carrito = await PersistenciaCarritos(persistencia)
